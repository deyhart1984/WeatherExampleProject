...
import com.weather_exp.app.utils.CommonUtils
import com.weather_exp.app.utils.NetworkUtils
...
abstract class BaseActivity : AppCompatActivity(), MvpView, BaseFragment.Callback {
    ...
    /*public void showPermissionDialog(final AskAgainCallback.UserResponse response) {
        new AlertDialog.Builder(this)
                .setTitle(getResources().getString(R.string.need_permission))
                ...
                .setNegativeButton(getResources().getString(R.string.notnow), new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
